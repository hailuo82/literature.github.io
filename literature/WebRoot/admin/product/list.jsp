	...
	<head>
		...
		<script type="text/javascript">
          ...
          function gotopage(page){
    	       window.location.href="${pageContext.request.contextPath}/adminProduct_findAllProduct.action?page="+page+"";
          }
		</script>
	</head>
	<body>
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="p" value="list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="60">
												<img src="<s:property value="#p.image"/>" width="60" height="40"/>
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="14%">
