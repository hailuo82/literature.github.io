...
<link href="${pageContext.request.contextPath}/css/index.css" rel="stylesheet" type="text/css"/>
  <script type="text/javascript">
       ...
       function gotopage(page,csid){
    	   window.location.href="${pageContext.request.contextPath}/product_findByCsid?page="+page+"&csid="+csid+"";
       }
  </script>
...
<div class="container productList">
	...
	<div class="pagination">
	      ...
	      <s:if test="page!=1">
	        <%--跳转到首页 --%>
			<a href="javascript:gotopage(1,${csid})" class="firstPage">&nbsp;</a>
			
			<%--上一页 --%>
			<a href="javascript:gotopage(${page}-1,${csid})" class="previousPage">&nbsp;</a>
		  </s:if>	  
		  ...
		  <s:iterator var="num" begin="%{beginIndex}" end="%{endIndex}">
			...
			<s:else>
			   <a href="javascript:gotopage(${num},${csid})">${num}</a>
			</s:else>
		  </s:iterator>
          
          <s:if test="page != pageCount">
			<%--下一页 --%>
			<a href="javascript:gotopage(${page}+1,${csid})" class="nextPage">&nbsp;</a>
			
			<%--跳转到尾页 --%>  
			<a href="javascript:gotopage(${pageCount},${csid})"class="lastPage">&nbsp;</a>
	      </s:if>
	  </div>
